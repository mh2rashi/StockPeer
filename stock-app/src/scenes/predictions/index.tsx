...
// import {ResponsiveContainer, LineChart, CartesianGrid, XAxis, Label, YAxis, Tooltip, Legend, Line} from 'recharts';
...
//     // const {data: kpiData} = useGetKpisQuery(); // Data getting passed through
...
//             ({revenue}, i:number) =>{
//                 return [i, revenue] // The modle requires [x,y] valules => We are formatting the [month, revenue]
//             }
//         );
...
//   return (
//     <DashboardBox width="100%" height="98%" p="1rem" overflow="hidden">
//         <FlexBetween m="1rem 2.5rem" gap="1">
//             <Box>
...
//              </XAxis>
//              <YAxis domain={[12000, 26000]} axisLine={{ strokeWidth: '0'}} style={{ fontSize: "12px"}} tickFormatter={(v) => `$${v}`}>
