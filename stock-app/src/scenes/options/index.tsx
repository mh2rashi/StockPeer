...
//         <Box sx={{ display: 'flex', width: '100%', gap:"1rem", padding:"0rem 0rem 1rem 0rem", color: palette.grey[300], flex:"1"}}>

//             {/* Stock Data  */}
//             <Box sx={{ display: 'flex', flexDirection: 'column', width: '25%', height:"100%", gap:"1rem",  overflow: 'auto'}}>
...
//                 {/* Sample Options */}
//                 <DashboardBox sx={{ display: 'flex', flexDirection: 'column', height: '50%', minWidth: '300px', overflow:"auto" }}>
...
//             {/* Payoff Graph */}
//             <DashboardBox sx={{ display: 'flex', flexDirection: 'column', width: '75%', height: '100%',  marginTop: '1rem', minWidth: '300px', overflow: 'auto', flex:"1"}}>
